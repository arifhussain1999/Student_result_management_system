...
public class addResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student/result/management/logout.png"))); // NOI18N
        ...
        jLabel4.setText("Engineering Drawing");
           ...
           String ed= jTextField4.getText();
            String dbms= jTextField5.getText();
             ...
             try{
               ...
               if(rs.next())
                       {
                           st.executeUpdate("insert into result(rollNumber,Physics,Maths,ED,DBMS,OS) values('"+roll+"','"+physics+"','"+maths+"','"+ed+"','"+dbms+"','"+os+"')");
